...
public class RetrieveChunkResponse implements Event {
    ...
    public RetrieveChunkResponse(String fileName, int chunkNumber, int chunkLength, byte[] chunk) {
        this.messageType = Protocol.RETRIEVE_CHUNK_RESPONSE.getValue();
    ...
    public RetrieveChunkResponse(byte[] incomingByteArray) throws IOException {
    ...
    public byte[] getbytes() throws IOException {
        ...
        dataOutputStream.writeInt(Protocol.RETRIEVE_CHUNK_RESPONSE.getValue());
