...
public class ErrorCorrectionForward implements Event {
    ...
    public ErrorCorrectionForward(String fileName, int chunkNumber, String brokenChunkServer) {
        this.messageType = Protocol.ERROR_CORRECTION_FORWARD.getValue();
        this.fileName = fileName;
        this.chunkNumber = chunkNumber;
        this.brokenChunkServer = brokenChunkServer;
    }

    public ErrorCorrectionForward(byte[] incomingByteArray) throws IOException {
    ...
    public byte[] getbytes() throws IOException {
        ...
        dataOutputStream.writeInt(Protocol.ERROR_CORRECTION_FORWARD.getValue());
