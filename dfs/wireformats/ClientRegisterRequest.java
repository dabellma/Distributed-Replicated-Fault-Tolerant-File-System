...
public class ClientRegisterRequest implements Event {

    private int messageType;
    private String ipAddress;
    private int portNumber;

    public ClientRegisterRequest(String ipAddress, int portNumber) {
        this.messageType = Protocol.CLIENT_REGISTER_REQUEST.getValue();
        this.ipAddress = ipAddress;
        this.portNumber = portNumber;
    }

    public ClientRegisterRequest(byte[] incomingByteArray) throws IOException {
    ...
    public byte[] getbytes() throws IOException {
        ...
        dataOutputStream.writeInt(Protocol.CLIENT_REGISTER_REQUEST.getValue());
